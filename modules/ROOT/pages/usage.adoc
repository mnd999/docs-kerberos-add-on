...
[source, csharp]
----
using (var driver = GraphDatabase.Driver(new Uri("bolt://neo4j.windomain.local:7687"), new KerberosTokenManager("neo4j")))
	{
		try
		{
        await using var session = driver.AsyncSession();
        var result = await session.RunAsync("MATCH () RETURN count(*) AS count");
